                ...
                if (action == "start") {
                    ...
                    when (action) {
                        ...
                        "answer", "continue", "retry" -> {
                            ...
                            require(p["if_revision"]?.jsonPrimitive?.longOrNull == existing.revision) { "REVISION_CONFLICT" }
                            require(when (action) {
